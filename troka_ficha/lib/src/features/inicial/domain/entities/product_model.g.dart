...
void _productSerialize(
  ...
  writer.writeDouble(offsets[2], object.unitValue);
}
...
Product _productDeserialize(
  ...
  final object = Product(
    eventName: reader.readStringOrNull(offsets[0]),
    name: reader.readString(offsets[1]),
    unitValue: reader.readDouble(offsets[2]),
  );
  object.id = id;
  return object;
}
...
extension ProductQueryFilter
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> eventNameIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> eventNameIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> eventNameEqualTo(
    String? value, {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> eventNameGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> eventNameLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> eventNameBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> eventNameStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> eventNameEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> eventNameContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> eventNameMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> eventNameIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'eventName',
        value: '',
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> eventNameIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'eventName',
        value: '',
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> unitValueEqualTo(
    double value, {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> unitValueGreaterThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> unitValueLessThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> unitValueBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ProductQuerySortBy on QueryBuilder<Product, Product, QSortBy> {
  QueryBuilder<Product, Product, QAfterSortBy> sortByEventName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'eventName', Sort.asc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> sortByEventNameDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Product, Product, QAfterSortBy> sortByUnitValue() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'unitValue', Sort.asc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> sortByUnitValueDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductQuerySortThenBy
  ...
  QueryBuilder<Product, Product, QAfterSortBy> thenByEventName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'eventName', Sort.asc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> thenByEventNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'eventName', Sort.desc);
    });
  }
  ...
  QueryBuilder<Product, Product, QAfterSortBy> thenByUnitValue() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'unitValue', Sort.asc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> thenByUnitValueDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'unitValue', Sort.desc);
    });
  }
...
extension ProductQueryWhereDistinct
  ...
  QueryBuilder<Product, Product, QDistinct> distinctByEventName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Product, Product, QDistinct> distinctByUnitValue() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductQueryProperty
  ...
  QueryBuilder<Product, String?, QQueryOperations> eventNameProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Product, double, QQueryOperations> unitValueProperty() {
    return QueryBuilder.apply(this, (query) {
